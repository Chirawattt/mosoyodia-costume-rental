const Home = () => {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center min-h-[100dvh] sm:min-h-screen bg-black">
        {/* ภาพพื้นหลังเบลอ */}
        <img
          src="/img/HomeBG.png"
        ...
        <div className="relative flex flex-col items-center justify-between z-10 text-center w-full max-w-sm min-h-[90vh]">
          ...
          {/* ที่อยู่และเบอร์โทร - ใช้ margin top auto เพื่อดันไปด้านล่าง */}
          <div className="w-full text-center text-white font-[Prompt] px-4 mt-auto pb-4">
